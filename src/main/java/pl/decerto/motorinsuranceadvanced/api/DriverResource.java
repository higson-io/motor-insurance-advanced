...
import pl.decerto.motorinsuranceadvanced.converter.DriverConverter;
import pl.decerto.motorinsuranceadvanced.service.DriverService;
...
public class DriverResource {
	...
	@Autowired
	public DriverResource(DriverService driverService, DriverConverter driverConverter) {
	...
	public DriverDto getDriver() {
		var driver = driverService.getDriver();
